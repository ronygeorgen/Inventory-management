...
class ItemAPITest(APITestCase):
    ...
    def test_get_items_list(self):
        ...
        self.assertEqual(response.data['count'], 3)  # Total 3 items (1 from setUp + 2 new ones)
        self.assertEqual(len(response.data['results']), 3)  # All 3 items should be in results
    ...
    def test_create_item(self):
        ...
        self.assertEqual(Item.objects.count(), 2)  # 1 from setUp + 1 new
